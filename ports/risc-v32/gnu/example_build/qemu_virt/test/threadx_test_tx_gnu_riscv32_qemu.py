...
# returns into _tx_thread_context_restore. At this point, a pending
# preemption is observable directly by comparing current_ptr (interrupted
# thread) and execute_ptr (thread chosen by the scheduler).
#
